        ...
        <div className="min-h-screen py-4 sm:py-10 px-4 sm:px-6 lg:px-8">
            <div className="max-w-xl mx-auto bg-sky-50 rounded-xl p-4 sm:p-6 lg:p-8 hover:shadow-blue-300 transition-shadow duration-300 w-full">
                ...
                <div className="mt-4 sm:mt-6 flex justify-center">
                    <button className="w-full sm:w-auto bg-blue-500 text-white px-4 sm:px-6 py-2 rounded-lg hover:bg-blue-600 transform hover:scale-105 transition-all duration-200 font-semibold shadow-md hover:shadow-lg text-sm sm:text-base">
                        Editar Perfil
                    </button>
                </div>
            </div>
